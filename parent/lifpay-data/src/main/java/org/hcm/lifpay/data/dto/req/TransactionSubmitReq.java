...
public class TransactionSubmitReq extends BaseRequest {
    ...
    @Schema(description = "支付方式：1=lightning，2=其他", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "交易类型：1=发送，2=接收", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "支付状态：1=完成，2=处理中，3=失败", requiredMode = Schema.RequiredMode.REQUIRED)
