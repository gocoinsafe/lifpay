...
public class ContactController {
    ...
    public @ResponseBody BaseResponse<IPage<ContactListResp>> getContactList(@RequestBody BaseRequest request) {
        log.info("getContactList request: " + JSON.toJSONString(request));
        BaseResponse<IPage<ContactListResp>> response = contactService.getContactList(request);
    ...
    public @ResponseBody BaseResponse<IPage<ContactListResp>> contactAdd(@RequestBody BaseRequest request) {
    ...
    public @ResponseBody BaseResponse<IPage<ContactListResp>> contactUpdate(@RequestBody BaseRequest request) {
    ...
    public @ResponseBody BaseResponse<IPage<ContactListResp>> contactDel(@RequestBody BaseRequest request) {
